...
import com.neet.artifact.framework.entity.GameObject;
...
public class Player extends MapObject implements GameObject {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.neet.artifact.entity.GameObject#reset()
	 */
	public void reset() {
		health = maxHealth;
		facingRight = true;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.neet.artifact.entity.GameObject#update()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.neet.artifact.entity.GameObject#draw(java.awt.Graphics2D)
	 */
